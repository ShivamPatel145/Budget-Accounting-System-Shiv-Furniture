...
import { salesOrdersService, SalesOrder } from "@/lib/sales-orders-service";
...
const SalesOrdersPage = () => {
  ...
  const handleConfirm = async (id: string) => {
    try {
      await salesOrdersService.confirm(id);
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Create orders and track revenue by cost center</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={(open) => open ? setIsDialogOpen(true) : handleDialogClose()}>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Select customer, add products, and assign cost center for revenue tracking
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        {[
          { title: "Total Orders", value: stats.totalOrders, subtitle: "All time", icon: ShoppingBag, color: "text-primary", bg: "bg-primary/10" },
          ...
          { title: "Confirmed", value: stats.confirmedOrders, subtitle: "Ready to invoice", icon: CheckCircle, color: "text-accent", bg: "bg-accent/10" },
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                {searchQuery ? "No orders match your search" : "No sales orders yet. Create your first one!"}
              </p>
            </div>
          ) : (
